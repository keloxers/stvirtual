...
<?php
	...
	$user = Sentry::findUserById($articulo->users_id);
...
<div class="pi-section-w pi-section-white pi-slider-enabled piTooltips piSocials">
	<div class="pi-section pi-padding-bottom-10">
		...
		<div class="pi-row">
			...
			<div class="fb-comments" data-href="http://www.santotomevirtual.com/articulos/{{$articulo->url_seo}}" data-numposts="5"></div>
